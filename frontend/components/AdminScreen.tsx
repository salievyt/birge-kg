...
import type { ItemDto, ResourceKey } from "@/lib/domain/types";
...
export function AdminScreen({ csrf, canModerate, busy, projects, clubs, ideas, admissions, onCreate, onDecide }: AdminScreenProps) {
